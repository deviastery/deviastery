...
:computer: Живу разработкой :3 <br>Работаю fullstack-разработчиком на .NET и пишу нейросети. В свободное время занимаюсь системным программированием и изучаю Computer science.
